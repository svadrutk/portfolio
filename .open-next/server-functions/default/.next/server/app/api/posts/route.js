...
> *Representation that doesn't compromise on craft. 4 stars out of 5.*`}];function o(){return r.map(e=>({...e,readTime:a(e.content)})).sort((e,t)=>e.date<t.date?1:-1)}function n(e){let t=r.find(t=>t.slug===e);return t?{...t,readTime:a(t.content)}:null}},2026:(e,t,s)=>{"use strict";s.r(t),s.d(t,{patchFetch:()=>p,routeModule:()=>d,serverHooks:()=>c,workAsyncStorage:()=>h,workUnitAsyncStorage:()=>u});var a={};s.r(a),s.d(a,{GET:()=>l});var r=s(6559),o=s(8088),n=s(7719),i=s(1038);async function l(){try{let e=(0,i.z)();return Response.json(e)}catch(e){return console.error("Error reading posts:",e),Response.json([],{status:500})}}let d=new r.AppRouteRouteModule({definition:{kind:o.RouteKind.APP_ROUTE,page:"/api/posts/route",pathname:"/api/posts",filename:"route",bundlePath:"app/api/posts/route"},resolvedPagePath:"/Users/svadrut/Documents/portfolio/src/app/api/posts/route.ts",nextConfigOutput:"standalone",userland:a}),{workAsyncStorage:h,workUnitAsyncStorage:u,serverHooks:c}=d;function p(){return(0,n.patchFetch)({workAsyncStorage:h,workUnitAsyncStorage:u})}},3033:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},4870:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},6487:()=>{},6559:(e,t,s)=>{"use strict";e.exports=s(4870)},8335:()=>{},9294:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-async-storage.external.js")}};var t=require("../../../webpack-runtime.js");t.C(e);var s=e=>t(t.s=e),a=t.X(0,[719],()=>s(2026));module.exports=a})();